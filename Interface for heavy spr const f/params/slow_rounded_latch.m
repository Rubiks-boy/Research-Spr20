...
p_d.m = logspace(-5, 3, 1000);      % Mass range of projectiles to simulate
...
p_d.pic_width = 1000;                % Width of outputted xva graph (number of data points)
p_d.pic_height = 1000;              % Width of outputted xva graph (number of data points)
