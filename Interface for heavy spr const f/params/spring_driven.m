...
p_d.m = logspace(-5, 1, 250);      % Mass range of projectiles to simulate
...
p_d.mass_lines = [45, 75, 150];   % Creates lines along certain masses corresponding to indices given
